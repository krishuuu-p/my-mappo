...
def get_config():
    ...
    parser.add_argument("--use_wandb", action='store_false', default=False, help="[for wandb usage], by default False, will use tensorboard to log data. Use this flag to enable wandb logging.")
    ...
    parser.add_argument("--num_drones", type=int, default=3, help="Number of drones for PyBullet drone environment")
